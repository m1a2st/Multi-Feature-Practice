...
public class JwtUtil {
    ...
    // // JWT
    // 過期時間
    // .signWith(Keys.hmacShaKeyFor(jwtSignKey.getBytes(StandardCharsets.UTF_8)),
    ...
    // }
    //
    // public List<SimpleGrantedAuthority> parseUserAuthoritiesFromToken(String
    // token) {
    // List<String> userRoles = parseToken(token).get(CLAIMS_KEY_USER_ROLES,
    // List.class);
    // return
